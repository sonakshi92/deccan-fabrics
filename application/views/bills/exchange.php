      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Exchange Billing: <?php ?></h3>
              </div>
              <!-- /.card-header -->
             <!-- /.card-header -->
             <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <form>
                    <td> <input type="text" name="stockno" class="form-control" placeholder="Scan Stock No." > </td>
                    ...
                    <td> <input type="number" class="form-control" name="discprice" placeholder="Discount Price" > </td>
                ...
                <div class="card-header">
                      ...
                      <button class="btn btn-danger fa fa-unlink" > Void </button>
                    </div>
              </div>
              <!-- /.card-body -->
            </div>
