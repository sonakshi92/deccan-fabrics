...
<div class="content-wrapper">
					...
					<div class="card">
						<div class="card-header">
							<div class="row">
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										<label>Outward Invoice No.</label>
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="col-md-2">
                                ...
                                <div class="col-md-3">
									<div class="form-group">
										<input type="button" value="Return Whole Invoice" class="btn btn-warning">
									</div>
								</div>
							</div>
						</div>
	...
	<div class="card-body">
		...
		<div class="card-body">
			...
			<input type="submit" class="btn btn-primary" value="Outward Goods">
		</div>
	</div>
</div>
